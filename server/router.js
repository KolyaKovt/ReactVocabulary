...
router.post("/vocabulary/create", async (req, res) => {
  try {
...
router.put("/vocabulary/rename", async (req, res) => {
...
router.delete("/vocabulary/delete", async (req, res) => {
  try {
...
router.post("/vocabulary/words/add", async (req, res) => {
  try {
...
router.delete("/vocabulary/words/delete", async (req, res) => {
  try {
...
router.put("/vocabulary/words/change", async (req, res) => {
  try {
...
router.put("/vocabulary/incrementCountOfRepetitions", async (req, res) => {
  try {
    const query = `UPDATE vocabularies
